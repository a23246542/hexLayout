...
function copyImg(){
    return gulp.src('./week4/source/assets/**/*')
    .pipe(gulp.dest('./public/glasses/assets/'))
}
...
//   task一般用字串，函數則是直接把變數加進來
  ...
  exports.default = gulp.series(
    ...
    //   clean,
      gulp.parallel(copyHtml,copyImg,sass,compileScss),  
      function(done){//也可確保都做完再來browserSync跟watch
        ...
        gulp.watch(['./week4/source/sass/**/*.scss'],gulp.series(sass,compileScss));//要改變寫法
